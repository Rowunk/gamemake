...
export class HandlePool {
  /**
   * @param {Object} [opts]
   * @param {number} [opts.capacity] max concurrent live handles (default 1024)
   */
  constructor(opts = {}) {
    ...
    if (this._indexBits >= 32)
      throw new RangeError('HandlePool: capacity too large for 32-bit handles');
